...
def generate_summary(request):
    try:
        ...
        pdf_document_text_chunks_summary = ""
        for chunk in pdf_document_text_chunks:
            ...
            pdf_document_text_chunks_summary += api_response.choices[0].message.content
        ...
        final_summary_api_response = client.chat.completions.create(
            model="gpt-4o-mini",
            messages=[
